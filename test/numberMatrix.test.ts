...
describe('Number Matrix', () => {
  ...
  test("Matrix not equal", () => {
    const a: NumberMatrix = new NumberMatrix([[1, 2], [3, 4]]);
    const b: NumberMatrix = new NumberMatrix([[1, 2], [3, 5]]);
  ...
  test("Matrix similar", () => {
    const a: NumberMatrix = new NumberMatrix([[1, 2], [3, 4]]);
    const b: NumberMatrix = new NumberMatrix([[1.0001, 2.0001], [3.0001, 4.0001]]);

    expect(a.similar(b, 0.001)).toBe(true);
  });

  test("Matrix get element", () => {
    const a: NumberMatrix = new NumberMatrix([[1, 2, 3], [4, 5, 6]]);
